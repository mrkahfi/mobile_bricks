...
abstract class $SignInStateCopyWith<$Res> {
  ...
  $Res call({EmailFormz email, PasswordFormz password, FormzStatus status});
}
...
class _$_SignInState implements _SignInState {
  ...
  @override
  String toString() {
    return 'SignInState(email: $email, password: $password, status: $status)';
  }
...
abstract class _SignInState implements SignInState {
  const factory _SignInState(
      {final EmailFormz email,
      final PasswordFormz password,
      final FormzStatus status}) = _$_SignInState;
