...
import 'package:kickavenue/src/app/config/app_config.dart';
import 'package:kickavenue/src/services/local/hive_service.dart';

const _defaultConnectTimeout = 15000;
const _defaultReceiveTimeout = 15000;

class DioClient {
  final String baseUrl = AppConfig.baseUrl.value;
